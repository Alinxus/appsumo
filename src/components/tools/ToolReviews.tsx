      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1">
            <Card className="bg-gray-50 rounded-2xl p-8 text-center border border-gray-200 shadow-sm">
            ...
            {reviews.length === 0 ? (
              ...
              <div className="space-y-6">
                {displayedReviews.map((review) => (
                  <Card key={review.id} className="bg-gray-50 rounded-2xl border border-gray-200 shadow-sm">
        ...
        <div className="mt-12 text-center">
          <Card className="bg-gray-50 border border-gray-200 rounded-2xl max-w-2xl mx-auto shadow-sm">
