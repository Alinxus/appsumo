      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/credits" className="text-sm text-gray-400 hover:text-white">
                  Credits
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Sell</h3>
            <ul className="mt-4 space-y-2">
              <li>
              ...
              <li>
                <Link href="/affiliate" className="text-sm text-gray-400 hover:text-white">
                  Affiliate Program
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Learn</h3>
            <ul className="mt-4 space-y-2">
              <li>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <a href="https://x.com/AtmetAI" className="text-gray-400 hover:text-white">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex-shrink-0 flex items-center mb-4 md:mb-0">
            ...
            <span className="text-xl font-bold text-white">ATMET</span>
          </div>
